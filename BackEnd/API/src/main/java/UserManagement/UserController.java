...
/**
 * The User controller receives requests and calls the corresponding service methods 
 *
 * @author Varun
 */
@RestController
public class UserController 
{
	 ...
	 * 
	 * @param username The username of the User from whom the ticket is to be removed
	 */
